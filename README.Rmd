...
[Finemapping using BLR models](Document/Finemapping_bayesian_linear_regression.html)  

Polygenic scoring (PGS) using Bayesian Linear Regression models and biological pathway information (Rohde et al. 2023).    
