...
[Gene set analysis using MAGMA](Document/Gene_set_analysis_blr_magma.html)  
...
[Gene set analysis using Bayesian MAGMA](Document/Pathway_prioritization_blr_magma.html)  

Polygenic Prioritization Scoring using BLR models and gene-level statistics derived from VEGAS (work in progress).   
[Gene ranking using Bayesian PoPS](Document/Pathway_prioritization_blr_magma.html)  
