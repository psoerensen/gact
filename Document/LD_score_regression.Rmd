...
# Introduction
This script demonstrates how to estimate narrow-sense heritability and genetic correlation using the LD Score Regression (LDSC) method within the context of a gact database. It includes examples of partitioning of heritability using different annotation sources. The script makes use of the qgg and gact libraries to process and analyze GWAS summary statistics.
