...
pgsC <- gscore(Glist=Glist, stat=fitC$stat)
paC <- acc(yobs=y[valid], ypred=pgsC[valid,], typeoftrait = "binary")
paC
```
...
pgsR <- gscore(Glist=Glist, stat=fitR$stat)
paR <- acc(yobs=y[valid], ypred=pgsR[valid,], typeoftrait = "binary")
paR
```
