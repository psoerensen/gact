...
<p><strong>Figure:</strong> Workflow of the marker set test project. (1) Get GWAS summary statistics data from genotypes and phenotypes. (2) Calculate gene-level statistics using different methods. (3) Create gene sets based on biological gene sets. (4) Design matrix to link genes to gene sets. (5) Combine gene sets and adjusted marker effects for genes to perform gene set test analysis using linear regression models.</p>
