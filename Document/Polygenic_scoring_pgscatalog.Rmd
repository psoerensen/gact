...
## Introduction
The Polygenic Score (PGS) Catalog is an open database that curates polygenic scores (PGS) for various traits and diseases. It provides standardized information on PGS development, validation, and performance, allowing researchers to access and compare scores across studies.
...
# Compute pathway specific polygenic scores
