...
#### Bayesian MAGMA gene set analysis for a single trait (T2D for EUR)
```{r, include=TRUE, eval=FALSE}
...
#### Multiple trait Bayesian MAGMA gene set analysis (T2D and CAD for EUR)
```{r, include=TRUE, eval=FALSE}
# Select GWAS study IDs
...
#### Multiple trait Bayesian MAGMA gene set analysis (T2D for EUR, EAS and SAS)
```{r, include=TRUE, eval=FALSE}
# Select GWAS study IDs
